...
/* generated l10n code */Scratch.translate.setup({"fi":{"_Hidden Blocks":"Salaiset lohkot"},"it":{"_Hidden Blocks":"Blocchi Nascosti"},"ja":{"_Hidden Blocks":"隠されたブロック集"},"ko":{"_Hidden Blocks":"숨겨진 블록"},"nl":{"_Hidden Blocks":"Verborgen blokken"},"pl":{"_Hidden Blocks":"Ukryte Bloki"},"ru":{"_Hidden Blocks":"Скрытые Блоки"},"zh-cn":{"_Hidden Blocks":"隐藏积木块"}});/* end generated l10n code */(function (Scratch) {
  "use strict";
