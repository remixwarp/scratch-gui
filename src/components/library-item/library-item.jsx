...
class LibraryItemComponent extends React.PureComponent {
    constructor(props) {
        super(props);
        this.insetImageRef = React.createRef();
    }

    componentDidMount() {
        if (this.insetImageRef.current) {
            this.insetImageRef.current.onerror = () => {
                this.insetImageRef.current.onerror = null;
                this.insetImageRef.current.src = 'data:image/png;base64,';
            };
        }
    }
