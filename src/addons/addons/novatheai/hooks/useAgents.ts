...
const DEFAULT_AGENTS: Agent[] = [
  {
    ...
    models: [
      { id: "rw-model-deepseek-r1-distill-qwen-32b", name: "DeepSeek R1 推理模型", modelId: "deepseek-r1-distill-qwen-32b" },
      { id: "rw-model-gemma-2b-it-lora", name: "Google Gemma 2B", modelId: "gemma-2b-it-lora" },
      { id: "rw-model-gemma-7b-it", name: "Google Gemma 7B", modelId: "gemma-7b-it" },
      { id: "rw-model-gemma-7b-it-lora", name: "Google Gemma 7B LoRA", modelId: "gemma-7b-it-lora" },
      { id: "rw-model-llama-3.1-8b-instruct-fast", name: "Meta Llama 3.1 8B Fast", modelId: "llama-3.1-8b-instruct-fast" },
      { id: "rw-model-llama-3.1-8b-instruct-fp8", name: "Meta Llama 3.1 8B FP8", modelId: "llama-3.1-8b-instruct-fp8" },
      { id: "rw-model-llama-3.2-1b-instruct", name: "Meta Llama 3.2 1B", modelId: "llama-3.2-1b-instruct" },
      { id: "rw-model-llama-3.2-3b-instruct", name: "Meta Llama 3.2 3B", modelId: "llama-3.2-3b-instruct" },
      { id: "rw-model-llama-3.3-70b-instruct-fp8-fast", name: "Meta Llama 3.3 70B", modelId: "llama-3.3-70b-instruct-fp8-fast" },
      { id: "rw-model-llama-4-scout-17b-16e-instruct", name: "Meta Llama 4 Scout 17B", modelId: "llama-4-scout-17b-16e-instruct" },
      { id: "rw-model-mistral-7b-instruct-v0.1", name: "Mistral 7B v0.1", modelId: "mistral-7b-instruct-v0.1" },
      { id: "rw-model-mistral-7b-instruct-v0.2", name: "Mistral 7B v0.2", modelId: "mistral-7b-instruct-v0.2" },
      { id: "rw-model-mistral-7b-instruct-v0.2-lora", name: "Mistral 7B v0.2 LoRA", modelId: "mistral-7b-instruct-v0.2-lora" },
      { id: "rw-model-llama-2-7b-chat-hf-lora", name: "Llama 2 7B LoRA", modelId: "llama-2-7b-chat-hf-lora" },
    ],
    locked: true,
  },
];
